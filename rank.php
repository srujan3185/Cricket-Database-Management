...
<table style="vertical-align: text-top;"><tr><th>
	...
	ENTER PLAYERNAME    <input type="text" name="name" placeholder=""><br>
	ENTER RUNS        <input type="number" name="runs" placeholder=""><br>
	ENTER WICKETS        <input type="number" name="wickets" placeholder=""><br>
	ENTER NUMBER_OF_MATCHES        <input type="number" name="no_of_matches" placeholder=""><br>
